<img id="captcha_image" alt="Captcha" src="../sxPlugins/captcha/captcha_2.php?rand=<?php echo rand(); ?>" />
...
<script>
    function sx_refreshCaptcha() {
        document.getElementById("captcha_image").src = '../sxPlugins/captcha/captcha_2.php?<?php echo microtime();?>';
    }
</script>