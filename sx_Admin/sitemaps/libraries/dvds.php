...
if (!empty(@$_POST["Create"])) {
    ...
    if (is_array($arrListXML)) {
        ...
        for ($r = 0; $r < $iRows; $r++) {
            ...
            $root->appendChild($doc->createElement('loc', $xmlSiteURL . $xmlFilmsFileURL . $arrListXML[$r][0]));
        ...
        $doc->save($strSitemapFolder . "films" . $strXMLSufix . ".xml");
        $urlViewXMLFile = $levelsBack . "films" . $strXMLSufix . ".xml";
        $doc = null;
    }
    $arrListXML = null;
}