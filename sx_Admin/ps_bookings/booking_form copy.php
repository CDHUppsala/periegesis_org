<div class="modal_reservations">
    <form id="jq_ReservationForm" class="modal_content" name="ReservationForm" action="" method="post">
        <input type="text" title="Customer ID" name="CustomerID" value="" readonly />
        <input type="text" title="Room ID" name="RoomID" value="" readonly />
        <input type="text" title="Checkin Date" name="CheckinDate" value="" readonly />
        <input type="text" title="Checkout Date" name="CheckoutDate" value="" readonly />
        <input type="text" title="Price" name="Price" value="" readonly />
        <input type="text" title="New Price" name="NewPrice" value="" placeholder="New Price" />
        <select title="Paid" name="Paid">
            <option value="0">0%</option>
            <option value="50">50%</option>
            <option value="100">100%</option>
        </select>
        <input type="text" title="Customer Email" name="CustomerEmail" value="" placeholder="Email" />
        ...
        <input type="text" title="Persons" name="Persons" value="" placeholder="Persons" />
...
<div class="modal_reservations">
    <form id="jq_ReservationFormEdit" class="modal_content" name="ReservationFormEdit" method="post">
        <input type="text" title="Booking ID" name="BookingID" value="" readonly />
        <input type="text" title="Admin ID" name="AdminID" value="" readonly />
        <input type="text" title="Customer ID" name="CustomerID" value="" readonly />
        <input type="text" title="Room ID" name="RoomID" value="" readonly />
        <input type="text" title="Checkin Date" name="CheckinDate" value="" readonly />
        <input type="text" title="Checkout Date" name="CheckoutDate" value="" readonly />
