<div id="jq_root_color_gradients" class="root_color_gradients">
    <style>
        <?php
        require __DIR__ . "/classes/linear.css";
        require __DIR__ . "/classes/circle.css";
        require __DIR__ . "/classes/ellipse.css";
        require __DIR__ . "/css/gradients.css";
        ?>
        .html_to_img_wrap {
    ...
    <div id="jq_root_variables">
        <div class="root_header" id="jq_root_header">
            <div class="root_flex_between roo_flex_nowrap root_flex_center">
                <h1>CSS Color Variables and Gradients</h1>
                <buttom id="jq_modal_open_button" title="OPEN/CLOSE fullscreen Modal Window"><img alt="Full Screen" data-close="images/sx_svg/sx_clear_bold.svg" src="images/sx_svg/sx_full_screen.svg" /></buttom>
            </div>
                ...
                <div id="jq_color_inputs">
                    <div class="root_inputs root_flex_between root_flex_end">
                        ...
                        <div class="root_flex_column">
                            <div title="Replace all occurrences of tints in gradients (white colors from 10% to 100% opacity) with color variables">
                                Click a Color to replace Background and Tints [?]
                            </div>
                            <div class="color_inputs_grid">
                                <label>
                            ...
                            <div class="root_absolute">
                                <div class="root_flex_end">
                                    <label class="change_gradients_ratio" title="Change the H/W aspect ratio of gradients">
                                        ...
                                        <button data-id="16/9">9/16</button>
    ...
    <script>
        <?php
        require __DIR__ . "/js/jq_ajax_functions.js";
        require __DIR__ . "/js/global_functions.js";
        require __DIR__ . "/js/get_colors.js";
        require __DIR__ . "/js/get_gradients.js";
        require __DIR__ . "/js/modal_window.js";
        ?>
    </script>
</div>