...
<head>
    ...
    <title>Public Sphere - Design Root Colors and Gradients</title>
    ...
    <script>
        <?php
        //require realpath(dirname($_SERVER['DOCUMENT_ROOT']) . "/sx_Admin/design/gradients/js/jq_functions.js");
        ?>
    </script>


<link rel="stylesheet" href="../../../sxCss/root_Colors.css">
...
<body>
    <div id="jq_root_color_gradients" class="root_color_gradients">
        ...
        <div id="jq_root_variables">
                    ...
                    <div id="jq_color_inputs">
                        <div class="root_inputs root_flex_between root_flex_end">
                            <div class="root_absolute">
                                <label>
                                    Uncheck Radios: <input type="radio" name="RootColors" value="Unchecked" checked />
                                </label>
                            </div>
                                ...
                                <div class="root_flex">
                                    <label>
                                        <select name="Opacity" id="opacity" title="Set the opacity for colors replacing tints. Has NO effect for tint/shade/tone colors.">
                                            <option value="1" selected>Color opacity</option>
            ...
            <div id="jq_InsertRootVariables">
                <div class="tabs">
                    <a data-id="jq_InsertRootColor" class="selected" href="javascript:void(0)">Show Root Colors</a>
                    <a data-id="jq_InsertRootGradients" href="javascript:void(0)">Show Root Gradients</a>
                </div>
    ...
    <script>
        ...
        require realpath(dirname($_SERVER['DOCUMENT_ROOT']) . "/sx_Admin/design/gradients/js/html_to_image.js");
        ?>
    </script>
