...
{
    echo '<a title="First Page" href="list.php?page=1">&#x276E&#x276E&#x276E&#x276E</a> |';
    if (i_CurrentPage > 1) {
        echo '<a title="Previous Page" href="list.php?page=' . (i_CurrentPage - 1) . '"> &#x276E&#x276E</a> |';
    } else {
        echo " &#x276E&#x276E |";
    }
    if (i_CurrentPage < int_PageCount) {
        echo '<a title="Next Page" href="list.php?page=' . (i_CurrentPage + 1) . '"> &#x276F&#x276F</a> |';
    } else {
        echo " &#x276F&#x276F |";
    }
    echo ' <a title="Last Page" href="list.php?page=' . int_PageCount . '">&#x276F&#x276F&#x276F&#x276F</a>';
}
...
{ ?>
    <form class="row flex_justify_start" method="post" name="searchForm" action="list.php?searchForm=yes">
        ...
        <a class="button" href="list.php?RequestTable=<?= REQUEST_Table ?>">Clear All</a>
    </form>
<?php
} ?>