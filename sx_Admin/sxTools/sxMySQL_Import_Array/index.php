...
<head>
    <title>Convert CSV, XML and JSON Data to PHP Array and Import to MySQL Tables</title>
...
<body class="body">
    <header id="header">
        ...
        <form action="load_external_files.php" method="post" title="Not Active">
            <button id="LoadExternalFiles" class="button" type="submit" disabled>Load External Files</button>
        </form>
    </header>
    <h2>Convert CSV, XML and JSON Data to PHP Array and Import to MySQL Tables</h2>
    <div class="maxWidthWide">
        ...
        <div>
            ...
            <b>Max Size</b> for CSV, XML and JSON Files: <?php echo (int)(ini_get('memory_limit')) / 10; ?>M.
        </div>
