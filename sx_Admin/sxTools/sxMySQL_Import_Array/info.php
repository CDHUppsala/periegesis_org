...
<div class="maxWidth">
    ...
    <ul class="display_none">
        ...
        <li>Since the Import file is converted to a <b>PHP Associative Array</b>, which consumes server memory, the <b>size</b> of the Import File must not exceed about <?php echo (int)(ini_get('memory_limit'))/10; ?>M. Otherwise, you must splitt it into two or more files.</li>
