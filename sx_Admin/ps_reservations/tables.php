        ...
        <table class="calendar_table reservations" id="jq_Reservations" data-date="<?= $sxCurrDate ?>" data-colspan="<?= $iColSpan ?>">
            <caption>
                <div class="row">
                    ...
                    <span>Click on Minutes to mark Start and End Time</span>
                </div>
            </caption>
            <tbody class="tbody_hours">
                ...
                <tr>
                    ...
                    for ($i = 0; $i < $iColumns; $i++) {
                        ...
                        <th class="marking_cells jq_marking_cells"><?= $z . $suffix ?></th>
                    <?php
                        $z += $timeInterval;
                        if ($z > $iMaxInterval) {
                            $z = 0;
    ...
    <script>
        ...
        for (i = 0; i < dataArray.length; i++) {
            ...
            div_el = '<div data-resid="' + int_ReservationID + '" ' +
                ...
                'data-seats="' + str_Seats + '">' + str_Seats + ' ' + str_CustomerName + ' ' + str_Phone + ' ' +
