...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $str_SelectedFields = "ProductID, GroupID, CategoryID, SubCategoryID, SubSubCategoryID, SexGroup, ProductName, ProductImages, ProductPrice, ProductGrossPrice, OfferRate, OfferPrice, ShowAsOffer, OfferStartDate, OfferEndDate, ShowAsNew, ShowAsSelected, ShowInFirstPage";

    if (!empty($strDBTable) && !empty($str_exportType)) {
        $sql = "SELECT $str_SelectedFields FROM products";
