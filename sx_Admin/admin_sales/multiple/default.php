...
<body class="body">
    ...
    if ($strSelectedTable == 'products' && empty($tempSelectedFields)) {
        $tempSelectedFields = "ProductID, GroupID, CategoryID, SubCategoryID, SubSubCategoryID, ProductName, ProductPrice, ProductGrossPrice, OfferRate, OfferPrice";
    } elseif ($strSelectedTable == 'product_accessories' && empty($tempSelectedFields)) {
        $tempSelectedFields = 'AccessoryID, GroupID, CategoryID, AccessoryName, AccessoryPrice, AccessoryDiscountPrice, Hidden';
    } ?>
    <section>
            ...
            <fieldset class="flex">
                ...
                <select name="SelectedTable" id="SelectedTable" onchange="sx_getFields(this.value)">
                    <option value="">Select Table</options>
                        ...
                        $arrTableList = [0 => [0 => 'products'], 1 => [0 => 'product_accessories']];
