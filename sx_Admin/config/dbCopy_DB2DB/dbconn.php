...
$strConnectToSourceDB = "";
$strConnectToTargetDB = "";
$strClearSourceDB = "";
$strClearTargetDB = "";


if (!empty($_POST["ConnectToSourceDB"])) {
    $strConnectToSourceDB = trim($_POST["ConnectToSourceDB"]);
}
if (!empty($_POST["ConnectToTargetDB"])) {
    $strConnectToTargetDB = trim($_POST["ConnectToTargetDB"]);
}
if (!empty($_POST["ClearSourceDB"])) {
    $strClearSourceDB = trim($_POST["ClearSourceDB"]);
}
if (!empty($_POST["ClearTargetDB"])) {
...
} elseif (!empty($_SESSION["ConnectToTargetDB"])) {
