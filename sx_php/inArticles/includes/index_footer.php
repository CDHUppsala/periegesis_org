...
/**
 * Special adaptations to Periegesis
 */
if (defined('SX_Inclued_Statistics_Periegesis') && SX_Inclued_Statistics_Periegesis) {
    //include PROJECT_PHP. "/app_statistics/periegesis/annotation_stats.php";
    include PROJECT_PHP . "/app_statistics/periegesis/index.php";
}
