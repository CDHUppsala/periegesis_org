<?php
include __DIR__ . "/functions_Nav_Items.php";

$strNavPath = "items.php?itemid=";
$aResults = null;
...
<div class="nav_head_menu" id="jqNavHeadMenu">
    <ul>
        ...
        if ($radio_IncludeItems && sx_radioUseItems) {
            ...
            $aResults = sx_getNavRowsForItemsByGroup();
            if (is_array($aResults)) {
                //sx_getListNavForItems($aResults, $strNavPath, $str_ItemsTitle);
                sx_getNavListForItemsByGroup($aResults, $strNavPath);
            }
            $aResults = null;
        }
