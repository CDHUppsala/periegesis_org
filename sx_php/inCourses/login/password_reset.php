...
if ($_SERVER["REQUEST_METHOD"] != "POST") {
    ...
    } elseif (!sx_valid_form_token("StudentResetPassword", $_POST["FormToken"])) {
        $radioValidToken = false;
    ...
    if ($radioContinue) {
        // Only one day after the request for reset
        ...
        $rs = null;
        /**
         * Unset session here, if records are not found bellow,
...
$strFormToken = sx_generate_form_token('StudentResetPassword', 128);
