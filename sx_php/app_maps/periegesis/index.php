...
<body>
    ...
    <div id="HidenInformation">
        <div>
            ...
            <p>Place names in the Greek text are automatically marked with place data from the original Recogito annotation, usually with coordinates derived from the Pleiades website or the Arachne (German Archaeological Institute) database. When annotations cannot be matched to the text, they appear in a list at the bottom of the Greek text. See our Nodegoat database for the mapping of sites not in Pleiades.</p>
