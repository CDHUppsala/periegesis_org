...
function init_MapInstance(map_Instance) {
    ...
    const map_Download = map_Instance.parentElement.querySelector('.download-wrapper');
    ...
    const scope_Constants = [map, map_Legends, map_Instance, map_Filters, map_Download, map_MetaData];
