...
function load_File_JSON(scope_Constants, data, extension, file_Name) {
    ...
    //[map, map_Legends, map_Instance, map_Filters, map_Download, map_MetaData]
    const [map, map_Legends, , map_Filters, map_Download] = scope_Constants;

    populate_Filters(map, map_Filters, map_Legends, map_Download, geojson, file_Name)

    const layerGroup = L.geoJSON(geojson);
    handle_LayerPopupHover(map, map_Legends, layerGroup, map_Filters, file_Name, extension);
}
...
function load_File_GeoJSON(scope_Constants, data, extension, file_Name) {
    if (data.type === "FeatureCollection" || data.type === "GeometryCollection") {
        ...
        const [map, map_Legends, map_Filters, map_Download] = scope_Constants;
        populate_Filters(map, map_Filters, map_Legends, map_Download, data, file_Name)

        const geoLayer = L.geoJSON(data);
        handle_LayerPopupHover(map, map_Legends, geoLayer, map_Filters, file_Name, extension);
...
function load_File_TopoJSON(scope_Constants, topoJSON, extension, file_Name) {
    ...
    populate_Filters(map, map_Filters, map_Legends, geojson, map_Download, file_Name)

    handle_LayerPopupHover(map, map_Legends, topoLayer, map_Filters, file_Name, extension);
...
function load_File_KML(scope_Constants, kmlText, extension, file_Name) {
    ...
    const [map, map_Legends, , map_Filters, map_Download, map_MetaData] = scope_Constants;
    ...
    populate_Filters(map, map_Filters, map_Legends, map_Download, geojson, file_Name);
    handle_LayerPopupHover(map, map_Legends, kmlLayer, map_Filters, file_Name, extension);
}
...
function load_File_GPX(scope_Constants, gpxText, extension, file_Name) {
    ...
    handle_LayerPopupHover(map, map_Legends, gpxLayer, map_Filters, file_Name, extension)
}
...
function load_File_CSV(scope_Constants, csvText, extension, file_Name) {
    ...
    handle_LayerPopupHover(map, map_Legends, geoLayer, map_Filters, file_Name, format);
}
/*
    ==================
