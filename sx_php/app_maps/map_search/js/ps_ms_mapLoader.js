 ...
 * FILE: ps_ms_mapLoader.js
 * LOADS THE BASIC openStreetMap + Tiles
 * ========================================================
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Wait until resizing stops for 200ms before repositioning
    window.addEventListener("resize", de_bounce(re_positionMap, 200));
});
