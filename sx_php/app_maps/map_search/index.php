...
<body>
    <div class="map_container">
        <div id="MapHeaderWrapper" class="map_header_wrapper">
            ...
            <div class="flex_buttons">
                ...
                <button id="SearchInputsToggle" class="button_svg" title="Show/Hide search inputs in mobiles"
            ...
            <div class="flex_checkboxes">
                <div>
                    <div>
                        ...
                        <button class="button_svg" onclick="toggle_PanelTools()"
                            title="Tools for filtering and conversion between GeoJson, KML and CSV Files">Tools</button>
                        <button class="button_svg" onclick="toggle_PanelDownloads()"
                    ...
                    <div>
                        ...
                        <label title="Enables/Disables Click Searching on the map">
                            <input type="checkbox" id="UseClickSearch"> Use Click Search
                        </label>
                    </div>
                </div>
            </div>
    ...
    <script>
        <?php
        include __DIR__ . "/js/ps_ms_config.js";
        include __DIR__ . "/js/ps_ms_mapLoader.js";
        include __DIR__ . "/js/ps_ms_mapLegends.js";
        include __DIR__ . "/js/ps_ms_mapSearch.js";
        include __DIR__ . "/js/ps_ms_mapPopupHover.js";
        include __DIR__ . "/js/ps_ms_fileLoader.js";
        include __DIR__ . "/js/ps_ms_fileSelector.js";
        include __DIR__ . "/js/ps_ms_fileSearch.js";
        include __DIR__ . "/js/ps_ms_mapClearing.js";
        include __DIR__ . "/js/ps_ms_panels.js";
        ?>
    </script>
    ...
    <script>
        <?php
        include __DIR__ . "/js/ps_load_modal_html.js";
        ?>
    </script>
