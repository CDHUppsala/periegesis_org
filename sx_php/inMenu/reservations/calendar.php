...
?>
<section class="calendar_wrapper" style="display: <?= $displayCalendar ?>">
    <table class="calendar_table">
        <tr>
            <th><a href="<?php echo sx_PATH . "?month=" . $iPrevMonth . "&year=" . $iPrevYear; ?>">&#x25C0;</a></th>
            <th colspan="6"><strong><?php echo lng_MonthNames[$iThisMonth - 1] . ' ' . $iThisYear; ?></strong></th>
            <th><a href="<?php echo sx_PATH . "?month=" . $iNextMonth . "&year=" . $iNextYear; ?>">&#x25B6;</a> </th>
        </tr>
        <tr>
            <th>W</th>
            <?php for ($i = 0; $i < 7; $i++) { ?>
