...
if ($radio_UseEvents) {
	require dirname(__DIR__) ."/inEvents/includes_first_page.php";
}
...
if ($radio_ShowTextsByCalendar) {
	if (sx_IncludeTextByCalender) {
		include dirname(__DIR__) ."/inText_Calendar/textsByCalendar_Nav.php";
	} elseif (sx_IncludeTextByYearMonth) {
		include dirname(__DIR__) ."/inText_Calendar/textsByYearMonth_Nav.php";
	}
}

if (sx_includeSpotLights) :
	include dirname(__DIR__) ."/sx_Spots.php";
endif;

if (sx_IncludeWeekProgram && $radio_IncludeWeekProgram) :
	include dirname(__DIR__) ."/inProgramWeek/default.php";
endif;

if ((sx_IncludeSurveys || sx_IncludeQuiz) && $radio_IncludePSQ):
	include PROJECT_PHP ."/inSurvey/include_surveys_aside.php";
endif;

if ($radio_ShowFavorites) :
	include dirname(__DIR__) ."/inLinks/link_favorites.php";
endif;
