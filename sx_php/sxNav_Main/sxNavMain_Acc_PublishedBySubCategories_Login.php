 ...
 */
 ...
 $aResults = sx_GetRecentTextsBySubCategories(true);

if (is_array($aResults)) {
    $iRows = count($aResults);
    $strNavPath = "texts.php?";
    if (!empty(lngRecentInUsersArea)) {
        $tmpTitle = lngRecentInUsersArea;
    } else {
        $tmpTitle = $str_PublishedTextsByClassTitle;
    } ?>
  <section class="jqNavMainToBeCloned">
    <h2 class="head slide_up_NU jqToggleNextRight_NU"><span><?= $tmpTitle ?></span></h2>
