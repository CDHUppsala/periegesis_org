...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($_POST['FormToken'])) {
		...
		write_To_Log("Users Send Password: Empty Token Hack-Attempt!");
	} elseif (!sx_valid_form_token("ResetUserPassword", $_POST["FormToken"])) {
		$radioValidToken = false;
		write_To_Log("Users Send Password: Wrong Token Hack-Attempt!");
	}
...
<?php
	...
	$strFormToken = sx_generate_form_token('ResetUserPassword', 128);
?>
