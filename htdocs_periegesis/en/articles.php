...
<body id="body_articles" class="body_one_column">
	<?php require PROJECT_PHP . "/sx_Header.php"; ?>
	<div class="page">
		<div class="content">
			<main class="main">
				<?php
				include PROJECT_PHP . "/inArticles/includes/articles_main.php";
				?>
			</main>
			<aside class="aside">
				<?php
				include PROJECT_PHP . "/inArticles/includes/articles_aside.php";
				?>
			</aside>
		</div>
	</div>
