tinymce.init({
    ...
    width: '100%',
    menubar: false,
    plugins: 'advlist autolink lists link image preview searchreplace visualblocks code fullscreen insertdatetime media table code help wordcount',
    toolbar: 'undo redo | formatselect | ' +
        'bold italic | bullist numlist outdent indent | removeformat | code preview fullscreen | ' +
        'alignleft aligncenter alignright alignjustify blockquote | ' +
        'table | media image link',
    entity_encoding: "raw",
