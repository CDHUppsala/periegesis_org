...
// To open the main page for the configuration database
CONST SX_AllowConfigDBPage = true;
// To show tools for the configuration database in content manu
CONST SX_ShowConfigDBToolsInMenu = true;
CONST sx_radioShowDesignTools = false;
