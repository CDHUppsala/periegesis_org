...
CONST SX_Inclued_Statistics_Periegesis = false;
CONST SX_Use_Extra_Tools = true;
CONST SX_Inclued_Extra_Tools_In_Main_Menu = true;
/**
...
CONST sx_ButtonSectionClass_1 = "button buton-big button-arrow";
CONST sx_ButtonSectionClass_2 = "button buton-big button-gradient";
...
// ADVERTISE FUNCTION
CONST sx_includeHeaderAds = false;
CONST sx_includeFooterSlider = false;
CONST sx_includeFooterMain = true;
CONST sx_includeFooterAds = false;
...
CONST sx_AboutHeaderMenuByGroups = true;
CONST sx_AboutHeaderMenuByGroupsInList = false;
CONST SX_includePrintsInAbout = false;
CONST SX_HideAboutNavMenu = true;
...
CONST SX_IncludeAboutTextsInFooter = false;
CONST SX_IncludeArticlesInFooter = false;
// In index.php show recent articles in the aside section
CONST SX_IncludeArticlesInIndexAside = false;
...
CONST SX_includeAppsNavigation = false;
...
CONST SX_showSpecialArtFooter = false;
CONST SX_showSpecialSimpleFooter = true;

/**
 * Adapted Application constants, to be included on the top menu
 */
CONST SX_IncludeWikidataSearch = false;
